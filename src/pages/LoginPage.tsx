            ...
            {isRegister && (
              <>
                ...
                <div>
                    ...
                    <input id="dob" name="dob" type="text" required className="appearance-none rounded-none relative block w-full px-3 py-3 border border-dark-border bg-gray-700 text-light-text placeholder-gray-400 focus:outline-none focus:ring-brand-primary focus:border-brand-primary focus:z-10 text-sm" placeholder="DD/MM/AAAA" value={dob} onChange={(e) => setDob(e.target.value)} />
                </div>
                <div>
